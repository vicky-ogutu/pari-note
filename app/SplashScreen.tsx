  ...
  return (
    <View style={tw`flex-1 bg-gradient-to-b from-blue-900 to-purple-700`}>
      <View style={tw`absolute top-0 left-0 w-full h-full`}>
        <View
          style={[
            tw`absolute rounded-full bg-white opacity-10`,
            {
              width: width * 0.7,
              height: width * 0.7,
              top: -width * 0.2,
        ...
        <View
          style={[
            tw`absolute rounded-full bg-white opacity-5`,
            {
              width: width * 0.9,
              height: width * 0.9,
              bottom: -width * 0.3,
      ...
      <View style={tw`flex-1 justify-center items-center`}>
        ...
        >
          ...
          <Text
            style={tw`text-purple-500 text-lg font-medium text-center max-w-xs leading-6`}
          >
          ...
          <View style={tw`mt-8 w-32`}>
            <View
              style={tw`h-1 bg-purple-900 opacity-30 rounded-full overflow-hidden`}
            >
              <Animated.View
                style={[
        ...
        <View style={tw`absolute bottom-8`}>
          <Text style={tw`text-purple-500 text-sm`}>Ministry of Health</Text>
        </View>
      </View>
    </View>
  );
